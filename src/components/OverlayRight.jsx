...
const OverlayRight = ({ image, text, color, transparency, duration, height, width }) => {
    ...
    return (
        <div className="overlay-container" style={{ height, width }}>
            ...
            <div className="overlay overlay-right overlay-text-1" style={{ backgroundColor: rgbaColor, transition: `width ${duration} ease-in-out` }}>
