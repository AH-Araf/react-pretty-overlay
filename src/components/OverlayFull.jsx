...
const OverlayFull = ({ image, text, color, transparency, duration, height, width }) => {
    ...
    return (
        <div className="overlay-container" style={{ height, width }}>
            ...
            <div className="overlay overlay-full overlay-text-1" style={{ backgroundColor: rgbaColor, transition: `opacity ${duration} ease-in-out` }}>
