...
const OverlayDown = ({ image, text, color, transparency, duration, height, width }) => {
    ...
    return (
        <div className="overlay-container" style={{ height, width }}>
            ...
            <div className="overlay overlay-down overlay-text-1" style={{ backgroundColor: rgbaColor, transition: `height ${duration} ease-in-out` }}>
